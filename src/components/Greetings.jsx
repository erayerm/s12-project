  ...
  return (
    <div className="w-screen relative pb-24 pt-[75px] dark:bg-bgDarkBlack bg-bgLightGray">
      ...
      <div className="p-0 max-w-[1100px] mx-auto my-0 h-full">
        <nav className="px-5 flex items-center gap-4 justify-end text-[15px] font-bold tracking-[0.05em] dark:text-textDarkGray text-black">
          <ToggleButton />
          <p>|</p>
        ...
        <div className="pt-20 px-10 flex justify-center gap-10 flex-wrap text-center lg:flex-nowrap lg:text-left">
          <div className="text-black dark:text-white flex flex-col justify-center w-full">
            ...
            <div className="flex gap-5 mx-auto mb-6 lg:mt-0 lg:mx-0">
              <a href="https://www.linkedin.com/in/erayermemis/">
                <svg
            ...
            <p className="text-lg font-normal tracking-[0.05em] w-full">
              ...
              <a href="mailto:ermemiseray@gmail.com">
                <span className="text-[#E92677]">ermemiseray@gmail.com</span>
              </a>
            </p>
          </div>
          <div>
