...
export default function Greetings(){
    ...
    return (
      <div className="w-screen pb-24 pt-[75px] dark:bg-bgDarkBlack bg-bgLightGray">
        <div className="p-0 max-w-[1100px] mx-auto my-0 h-full">
          ...
          <div className="pt-20 flex justify-between">
            <div className="max-w-[70%] text-black dark:text-white">
              ...
              <p className="text-textLightBlack dark:text-white text-[42px] font-medium tracking-[0.01em] w-[85%] mb-14">
